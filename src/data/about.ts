...
- **Programs (4)** — curriculum + hands-on labs + **Practice Workbook** (basic→applied→advanced)
...
**드림아이티비즈 대표 · 정보관리박사(Ph.D)** — IT 교육과 인적자원개발(HRD) 분야의 교육 전문가로, 생성형 AI 활용 교육과 에듀테크 플랫폼 개발에 주력하고 있습니다. **122개**의 교육 사이트를 직접 설계·개발·운영하며 대학·공공기관·기업을 대상으로 AI 활용 역량 강화 교육을 제공합니다.
...
- **IT·디지털 전환**: 기업 DX 컨설팅, 웹 시스템 구축, 데이터 분석
...
**연락처** — aebon@dreamitbiz.com · [www.dreamitbiz.com](https://www.dreamitbiz.com)`,
...
**CEO, DreamIT Biz · Ph.D in Information Management** — An education expert in IT education and HRD, focusing on generative AI training and edtech platform development. Designs and operates **122** education sites for universities, public institutions, and corporations.
...
- **IT / Digital Transformation**: DX consulting, web systems, data analysis
...
> **"AI is a tool; real innovation is made by people."** — 30% theory · 70% practice.

**Contact** — aebon@dreamitbiz.com · [www.dreamitbiz.com](https://www.dreamitbiz.com)`,
    },
    {
      title: '정동엽 강사',
...
**직업미래연구소 소장 · 동아방송예술대학교 겸임교수** — IT 분야에서 **20년 이상**의 경력을 보유한 직업교육 전문가입니다. 직업학 박사과정을 수료하고, 미래 직업 트렌드 연구와 AI 기반 교육 설계에 주력하고 있습니다.
...
> **『생각의 미래』** (지식노마드, 2016) — 미래 사회의 변화와 직업의 진화를 예측하며, 새로운 시대에 필요한 사고력과 역량을 제시하는 책.`,
      contentEn: `<div class="instructor-hero">
...
**Director, Vocational Futures Research Institute · Adjunct Professor, Dong-ah Institute of Media and Arts** — A vocational education expert with over **20 years** in IT, focusing on future career research and AI-based education design.

### Core Competencies

- **Future Careers Research**: Analyzing job changes in the 4th Industrial Revolution era
- **AI Education Design**: Planning and operating generative AI programs
- **Career Counseling**: Career design, vocational psychology testing
- **Education Content**: Digital learning material and online course design
...
> **"The Future of Thinking"** (Knowledge Nomad, 2016) — predicts changes in future society and the evolution of careers.`,
    },
  ],
};
