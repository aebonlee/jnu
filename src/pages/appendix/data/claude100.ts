...
export default {
  ...
  sections: [
    {
      title: '1. 프롬프트 기본기 (01–15)',
      titleEn: '1. Prompt Basics (01–15)',
...
**15. 프롬프트 개선 요청**
"내 프롬프트를 더 잘 쓰는 방법 알려줘"라고 물어보면 클로드가 내 요청 방식 자체를 고도화해줍니다. 프롬프트를 프롬프트로 개선하는 루프입니다.`,
...
**15. Ask it to improve your prompt** — "tell me how to write this prompt better" upgrades your requests themselves.`,
    ...
    {
      title: '2. 글쓰기 & 콘텐츠 (16–30)',
      titleEn: '2. Writing & Content (16–30)',
...
**30. 에디터 역할 요청**
"작가가 아닌 편집자 입장에서 이 글의 문제점만 짚어줘"라고 하면 구조, 흐름, 설득력 측면에서 냉정한 피드백을 받을 수 있습니다.`,
...
**30. Ask for the editor's role** — "point out only the problems as an editor" gives cold, structural feedback.`,
    ...
    {
      title: '3. 리서치 & 분석 (31–45)',
      titleEn: '3. Research & Analysis (31–45)',
...
**45. 검색 쿼리 설계**
"이 주제를 조사하려면 구글에서 뭐라고 검색해야 해?"라고 하면 효과적인 검색 쿼리 목록이 나옵니다. 리서치 시작 전 검색 전략을 세우는 데 씁니다.`,
...
**45. Design search queries** — "what should I search on Google for this topic?" sets a search strategy.`,
    ...
    {
      title: '4. 업무 & 비즈니스 (46–60)',
      titleEn: '4. Work & Business (46–60)',
...
**60. 인수인계 문서 자동화**
업무를 설명하면 새 담당자가 바로 시작할 수 있는 인수인계 문서 구조를 만들어줍니다.`,
...
**60. Automate handover docs** — a structure a new owner can start from immediately.`,
    ...
    {
      title: '5. 코딩 & 자동화 (61–72)',
      titleEn: '5. Coding & Automation (61–72)',
...
**72. 데이터 파이프라인 설계**
소스에서 정제, 저장, 시각화까지의 흐름을 설계해달라고 하면 전체 구조를 한눈에 볼 수 있게 정리해줍니다.`,
...
**72. Data pipeline design** — from source to cleaning, storage, and visualization at a glance.`,
    ...
    {
      title: '6. 학습 & 정리 (73–83)',
      titleEn: '6. Learning & Organizing (73–83)',
...
**83. 복잡한 문서 → 1페이지**
긴 계약서, 정책 문서, 보고서를 "비전문가가 알아야 할 핵심만 1페이지로 압축해줘"라고 하면 빠르게 파악이 가능합니다. 단, 중요한 결정 전에는 원문도 꼭 확인하세요.`,
...
**83. Complex document → one page** — "compress to one page of what a non-expert needs" (still check the original before big decisions).`,
    ...
    {
      title: '7. 고급 테크닉 (84–100)',
      titleEn: '7. Advanced Techniques (84–100)',
...
**100. 나만의 꿀팁 시스템 구축**
효과 좋은 프롬프트를 프로젝트에 저장해두세요. 매번 새로 만드는 것이 아니라 쌓아가는 것이 장기적으로 훨씬 효율적입니다. 내 업무에 맞게 최적화된 프롬프트 라이브러리가 곧 경쟁력이 됩니다.`,
