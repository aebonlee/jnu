...
const SITES: SiteItem[] = [
  ...
  {
    name: 'DreamIT Papers · 논문작성',
    nameEn: 'DreamIT Papers',
    url: 'https://papers.dreamitbiz.com',
    icon: 'fa-file-lines',
    descKo: '학술 논문의 구조·작성법·인용·투고까지 논문 작성 전 과정을 학습하는 플랫폼입니다.',
    descEn: 'A platform for learning the full academic paper-writing process: structure, writing, citation, and submission.',
    category: 'research',
    tags: ['논문작성', '학술', '인용·투고'],
  },
  {
    name: 'Survey · 논문작성 가이드',
    nameEn: 'Survey · Paper Writing Guide',
    url: 'https://survey.dreamitbiz.com',
    icon: 'fa-pen-nib',
    descKo: '논문작성의 전 과정을 체계적으로 배우는 학습 플랫폼입니다.',
    descEn: 'A learning platform to systematically master the entire paper-writing process.',
    category: 'research',
    tags: ['논문작성', '학술글쓰기', '체계학습'],
  },
  {
    name: 'Planning · 경영기획',
