export const translations: Record<string, Record<string, unknown>> = {
  ko: {
    ...
    footer: {
      tagline: '전남대학교 교수자·직원·조교를 위한 생성형 AI 교육 플랫폼',
      companyInfo: '회사 정보',
      contact: '연락처',
      quickLinks: '바로가기'
    },
    ...
    subscription: {
      active: '구독 중',
      expired: '만료됨',
      noSubscription: '구독 중인 요금제가 없습니다.',
      expiresAt: '만료일',
      plan: '플랜',
      managePlan: '요금제 관리',
      monthlyTokens: '월 사용 토큰',
      monthlyRequests: '월 요청 수',
    },
    dashboard: {
      welcome: '환영합니다',
    ...
    site: {
      nav: {
        ...
        recommended: '추천사이트',
        recChatGPT: 'ChatGPT (OpenAI)',
        recClaude: 'Claude (Anthropic)',
        recGemini: 'Gemini (Google)',
        recCopilot: 'Copilot (Microsoft)',
        recPerplexity: 'Perplexity AI',
        recNotebookLM: 'NotebookLM (Google)',
        recDreamIT: 'DreamIT Biz (본사이트)',
        recTeaching: '교수학습 AI 도구',
      },
      home: {
        ...
        heroTitle: '전남대학교',
        heroHighlight: '생성형 AI 교육 플랫폼',
        heroDesc: '교수자·직원·조교를 위한 AI 기반 교수학습 도구와 맞춤형 교육 과정을 제공합니다.',
        heroCTA: '교육과정 보기',
        heroSecondaryCTA: 'AI 도구 체험',
        coursesTitle: '맞춤형 교육 과정',
        coursesDesc: '대상별 특화된 AI 교육 과정을 제공합니다.',
        toolsTitle: 'AI 교수학습 도구',
        toolsDesc: 'AI를 활용한 5가지 교수학습 지원 도구를 체험하세요.',
        statsTitle: '교육 현황',
        ctaTitle: '지금 바로 시작하세요',
        ctaDesc: 'AI 교육 플랫폼에서 교수학습 혁신을 경험하세요.',
        ctaButton: '무료 회원가입',
      }
    }
  },
  ...
  en: {
    ...
    pricing: {
      title: 'Pricing',
      subtitle: 'Use AI tools more conveniently',
      subscribe: 'Subscribe',
    ...
    site: {
      nav: {
        ...
        materials: 'Materials',
        matAiBasics: 'AI Basics',
        matDocument: 'Document Automation',
        matAdmin: 'Administration',
        matPrompt: 'Prompt Engineering',
        aiTools: 'AI Tools',
        ...
        recPerplexity: 'Perplexity AI',
        recNotebookLM: 'NotebookLM (Google)',
        recDreamIT: 'DreamIT Biz (Main)',
        recTeaching: 'AI Teaching Tools',
      },
      home: {
        title: 'CNU AI Education',
        ...
        heroTitle: 'Chonnam National University',
        heroHighlight: 'Generative AI Education Platform',
        heroDesc: 'AI-powered teaching tools and customized courses for faculty, staff, and teaching assistants.',
        heroCTA: 'View Courses',
        heroSecondaryCTA: 'Try AI Tools',
        coursesTitle: 'Customized Courses',
        coursesDesc: 'Specialized AI education courses for each audience.',
        toolsTitle: 'AI Teaching Tools',
        toolsDesc: 'Experience 5 AI-powered teaching support tools.',
        statsTitle: 'Education Status',
        ctaTitle: 'Get Started Today',
        ctaDesc: 'Experience teaching innovation on the AI education platform.',
