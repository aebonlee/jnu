// 4개 과정별 게시판 (교육과정·학습자료와 동일한 id 체계)
export const BOARDS = [
  {
    id: 'foundation',
    icon: 'fa-seedling',
    ...
    descKo: '기초·심화 과정 수강생들이 자료·질문·후기를 나누는 게시판입니다.',
    descEn: 'For learners of the Foundations & Advanced program.',
    color: '#1A2B4A',
  },
  {
    id: 'research-writing',
    ...
    descKo: '데이터분석·논문작성 과정 수강생들의 자료·질문·토론 공간입니다.',
    descEn: 'For learners of the Data Analysis & Academic Writing program.',
    color: '#0F2A4A',
  },
  {
    id: 'data-budget',
    ...
    descKo: '데이터분석·예산회계 과정 수강생들의 자료·질문·토론 공간입니다.',
    descEn: 'For learners of the Data Analysis & Budget Accounting program.',
    color: '#00553F',
  },
  {
    id: 'research-lab',
    ...
    descKo: '연구·실험지원 과정 수강생들의 자료·질문·토론 공간입니다.',
    descEn: 'For learners of the Research & Experiment Support program.',
    color: '#1A2B4A',
  },
];
