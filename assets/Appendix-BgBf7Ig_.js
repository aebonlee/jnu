import{l as e}from"./index-BDp2fxWm.js";import{G as t}from"./GuidePage-ClFiRwoM.js";/* empty css                 */import"./SEOHead-BuGSSDqS.js";import"./TipBox-CBZ_gp_d.js";import"./index-D_M0lzwZ.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
> **Security**: 전남대GPT is campus-only, safer than public services — but still minimize sensitive data (IDs, unpublished research).`},{title:"제공사별 모델",titleEn:"Models by Provider",content:`> 회사마다 **설계 철학과 강점**이 다릅니다. 아래는 아키텍처·용도 관점의 **상세 안내**입니다. (구체 수치·벤치마크는 자주 바뀌어 생략 — 잘 모르면 Auto)
