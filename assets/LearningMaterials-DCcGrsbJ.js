...
- Save successful prompts for reuse`}];function w(){const{category:d}=I(),{language:a}=C(),[i,u]=l.useState(d||r[0]?.id||"ai-basics"),[c,s]=l.useState(null),o=r.find(t=>t.id===i),p=m.filter(t=>t.categoryId===i),n=c?m.find(t=>t.id===c):null,g=t=>{u(t),s(null)},A=t=>{s(t),window.scrollTo({top:0,behavior:"smooth"})},h=()=>{s(null),window.scrollTo({top:0,behavior:"smooth"})};return e.jsxs(e.Fragment,{children:[e.jsx(f,{title:a==="ko"?"학습자료":"Learning Materials",path:"/materials"}),e.jsx("section",{className:"page-header",children:e.jsxs("div",{className:"container",children:[e.jsx("h1",{children:a==="ko"?"학습자료":"Learning Materials"}),e.jsx("p",{children:a==="ko"?"교육에 필요한 자료를 카테고리별로 제공합니다.":"Educational materials organized by category."})]})}),e.jsx("section",{className:"section",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"materials-layout",children:[e.jsx("aside",{className:"materials-sidebar",children:e.jsx("nav",{children:r.map(t=>e.jsxs("button",{className:`sidebar-item ${i===t.id?"active":""}`,onClick:()=>g(t.id),children:[e.jsx("i",{className:`fa-solid ${t.icon}`}),a==="ko"?t.nameKo:t.nameEn]},t.id))})}),e.jsx("div",{className:"materials-content",children:n?e.jsxs(e.Fragment,{children:[e.jsxs("button",{className:"btn btn-outline btn-back",onClick:h,children:[e.jsx("i",{className:"fa-solid fa-arrow-left"}),a==="ko"?"목록으로 돌아가기":"Back to list"]}),e.jsx("h2",{children:a==="ko"?n.nameKo:n.nameEn}),e.jsx("span",{className:"material-type",children:n.type}),e.jsx("div",{className:"markdown-body",children:e.jsx(P,{remarkPlugins:[y],rehypePlugins:[G],children:a==="ko"?n.contentKo:n.contentEn})})]}):o?e.jsxs(e.Fragment,{children:[e.jsx("h2",{children:a==="ko"?o.nameKo:o.nameEn}),e.jsx("p",{className:"materials-desc",children:a==="ko"?o.descKo:o.descEn}),e.jsx("div",{className:"materials-list",children:p.map(t=>e.jsxs("div",{className:"material-item",onClick:()=>A(t.id),style:{cursor:"pointer"},children:[e.jsx("div",{className:"material-icon",children:e.jsx("i",{className:`fa-solid ${t.type==="guide"?"fa-book":t.type==="template"?"fa-file-alt":"fa-bookmark"}`})}),e.jsxs("div",{className:"material-info",children:[e.jsx("h4",{children:a==="ko"?t.nameKo:t.nameEn}),e.jsx("span",{className:"material-type",children:t.type})]})]},t.id))})]}):null})]})})})]})}export{w as default};
