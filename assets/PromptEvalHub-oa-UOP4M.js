import{r as A,l as e,C as k,L as v}from"./index-CAwQAu4X.js";import{S as N}from"./SEOHead-D5UO9DTD.js";import{M as O,r as D}from"./index-xKj4WacK.js";import{r as q}from"./index-CYEKmvRs.js";import{P as M}from"./practice-lutjXDOa.js";const G=/←|highlight|주목|중요|important/i;function C(t){return t.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const F=[{type:"comment",re:/#.*$/gm},{type:"string",re:/("""[\s\S]*?"""|'''[\s\S]*?'''|"(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*')/g},{type:"decorator",re:/@[\w.]+/g},{type:"keyword",re:/\b(import|from|as|def|class|return|if|elif|else|for|while|try|except|finally|with|raise|yield|async|await|pass|break|continue|and|or|not|in|is|lambda|global|nonlocal|del|assert)\b/g},{type:"builtin",re:/\b(True|False|None|self|cls|print|len|range|int|str|float|list|dict|set|tuple|type|isinstance|enumerate|zip|map|filter|super|open|input|sorted|reversed|any|all|min|max|sum|abs|round|format|hasattr|getattr|setattr)\b/g},{type:"function",re:/\b([a-zA-Z_]\w*)\s*(?=\()/g},{type:"number",re:/\b\d+(\.\d+)?\b/g},{type:"operator",re:/([+\-*/%=<>!&|^~:]+|->|\.\.\.)/g}],B=[{type:"comment",re:/(\/\/.*$|\/\*[\s\S]*?\*\/)/gm},{type:"string",re:/(`(?:\\.|[^`\\])*`|"(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*')/g},{type:"keyword",re:/\b(import|from|export|default|const|let|var|function|return|if|else|for|while|do|switch|case|break|continue|class|extends|new|this|super|try|catch|finally|throw|async|await|yield|typeof|instanceof|void|delete|in|of)\b/g},{type:"builtin",re:/\b(true|false|null|undefined|NaN|Infinity|console|window|document|Promise|Array|Object|String|Number|Boolean|Map|Set|JSON|Math|Date|RegExp|Error|Symbol|BigInt)\b/g},{type:"function",re:/\b([a-zA-Z_$]\w*)\s*(?=\()/g},{type:"number",re:/\b\d+(\.\d+)?\b/g},{type:"operator",re:/([+\-*/%=<>!&|^~?:]+|=>|\.\.\.)/g}],L=[{type:"comment",re:/#.*$/gm},{type:"string",re:/("(?:\\.|[^"\\])*"|'[^']*')/g},{type:"keyword",re:/\b(if|then|else|elif|fi|for|while|do|done|case|esac|in|function|return|exit|export|source|local|readonly|declare|unset|shift|break|continue)\b/g},{type:"builtin",re:/\b(echo|cd|ls|cat|grep|sed|awk|find|mkdir|rm|cp|mv|chmod|chown|curl|wget|pip|npm|npx|node|python|python3|git|docker|sudo|apt|brew|yarn|pnpm|bun|gh)\b/g},{type:"function",re:/\$\{?\w+\}?/g},{type:"number",re:/\b\d+\b/g},{type:"operator",re:/([|&;<>]+|>>|&&|\|\|)/g}],W=[{type:"string",re:/("(?:\\.|[^"\\])*")\s*(?=:)/g},{type:"string",re:/:\s*("(?:\\.|[^"\\])*")/g},{type:"builtin",re:/\b(true|false|null)\b/g},{type:"number",re:/\b-?\d+(\.\d+)?([eE][+-]?\d+)?\b/g}];function H(t){const i=(t||"").toLowerCase();return["python","py"].includes(i)?F:["javascript","js","jsx","typescript","ts","tsx"].includes(i)?B:["bash","sh","shell","zsh","terminal","console"].includes(i)?L:["json","jsonc"].includes(i)?W:[{type:"comment",re:/(\/\/.*$|#.*$|\/\*[\s\S]*?\*\/)/gm},{type:"string",re:/("(?:\\.|[^"\\])*"|'(?:\\.|[^'\\])*'|`(?:\\.|[^`\\])*`)/g},{type:"keyword",re:/\b(import|from|export|const|let|var|function|def|class|return|if|else|for|while|try|catch|except|with|async|await|new|this|self)\b/g},{type:"builtin",re:/\b(true|false|null|undefined|None|True|False)\b/g},{type:"number",re:/\b\d+(\.\d+)?\b/g}]}function z(t,i){const n=[];for(const o of i){const h=new RegExp(o.re.source,o.re.flags);let r;for(;(r=h.exec(t))!==null;){const m=r[1]!==void 0&&o.type!=="comment"&&o.type!=="keyword"&&o.type!=="builtin"&&o.type!=="decorator"?r[1]:r[0],d=r.index+(r[0].length-m.length);n.push({start:d,end:d+m.length,type:o.type,text:m})}}n.sort((o,h)=>o.start-h.start||h.end-o.end);const l=[];let s=0;for(const o of n)o.start>=s&&(l.push(o),s=o.end);let p="",a=0;for(const o of l)o.start>a&&(p+=C(t.slice(a,o.start))),p+=`<span class="token ${o.type}">${C(o.text)}</span>`,a=o.end;return a<t.length&&(p+=C(t.slice(a))),p}function U(t,i){const n=H(i);return t.split(`
`).map(s=>{const p=G.test(s),a=z(s,n);return p?`<span class="code-line-highlight">${a}</span>`:a}).join(`
`)}function P({code:t,language:i=""}){const[n,l]=A.useState(!1),s=async()=>{try{await navigator.clipboard.writeText(t),l(!0),setTimeout(()=>l(!1),2e3)}catch{const a=document.createElement("textarea");a.value=t,document.body.appendChild(a),a.select(),document.execCommand("copy"),document.body.removeChild(a),l(!0),setTimeout(()=>l(!1),2e3)}},p=U(t,i);return e.jsxs("div",{className:"code-block-wrapper",children:[e.jsxs("div",{className:"code-block-header",children:[e.jsx("span",{className:"code-block-lang",children:i}),e.jsxs("button",{className:`code-copy-btn ${n?"copied":""}`,onClick:s,children:[e.jsx("i",{className:`fa-solid ${n?"fa-check":"fa-copy"}`}),n?"Copied!":"Copy"]})]}),e.jsx("div",{className:"code-block-content",children:e.jsx("pre",{children:e.jsx("code",{dangerouslySetInnerHTML:{__html:p}})})})]})}const $={tip:"fa-lightbulb",warning:"fa-triangle-exclamation",important:"fa-circle-info",danger:"fa-circle-xmark"},K={tip:"Tip",warning:"Warning",important:"Important",danger:"Danger"};function Q({type:t="tip",title:i,children:n}){return e.jsxs("div",{className:`tip-box ${t}`,children:[e.jsx("span",{className:"tip-box-icon",children:e.jsx("i",{className:`fa-solid ${$[t]}`})}),e.jsxs("div",{className:"tip-box-content",children:[i&&e.jsx("strong",{children:i}),!i&&e.jsx("strong",{children:K[t]}),e.jsx("div",{children:n})]})]})}const Z={code({inline:t,className:i,children:n,...l}){const s=/language-(\w+)/.exec(i||"");return!t&&s?e.jsx(P,{code:String(n).replace(/\n$/,""),language:s[1]}):!t&&!s&&String(n).includes(`
`)?e.jsx(P,{code:String(n).replace(/\n$/,""),language:""}):e.jsx("code",{className:"inline-code",...l,children:n})},table({children:t}){return e.jsx("div",{className:"table-responsive",children:e.jsx("table",{children:t})})},blockquote({children:t}){return e.jsx(Q,{type:"tip",children:t})},a({href:t,children:i,...n}){return t&&t.startsWith("/")?e.jsx("a",{href:t,...n,children:i}):e.jsx("a",{href:t,target:"_blank",rel:"noopener noreferrer",...n,children:i})}};function J({seoTitle:t,seoTitleEn:i,seoDescription:n,path:l,dataFiles:s,ctaBanner:p,sidebarHeader:a,sidebarFooter:o}){const{language:h}=k(),r=h==="ko",m=[];s.forEach((c,u)=>{c.sections.forEach(g=>{m.push({section:g,fileIndex:u})})});const[d,I]=A.useState(0),f=m[d],R=f?.fileIndex??0,y=c=>{I(c),window.scrollTo({top:0,behavior:"smooth"})},T=s.length>1,b=[];let E=0;return s.forEach(c=>{b.push(E),E+=c.sections.length}),e.jsxs("div",{className:"guide-page",children:[e.jsx(N,{title:r?t:i||t,description:n,path:l}),e.jsxs("div",{className:"guide-layout",children:[e.jsxs("aside",{className:"guide-sidebar",children:[a,e.jsx("div",{className:"guide-sidebar-title",children:r?"목차":"Contents"}),e.jsx("ul",{className:"guide-nav",children:T?s.map((c,u)=>{const g=u===R,S=b[u];return e.jsxs("li",{className:`guide-nav-group${g?" expanded":""}`,children:[e.jsxs("button",{className:`guide-nav-group-toggle${g?" active":""}`,onClick:()=>y(S),children:[r?c.title:c.titleEn,e.jsx("i",{className:`fa-solid fa-chevron-${g?"down":"right"} group-chevron`})]}),g&&e.jsx("ul",{className:"guide-nav-sub-list",children:c.sections.map((w,j)=>{const x=S+j;return e.jsx("li",{className:"guide-nav-item",children:e.jsx("button",{className:`guide-nav-link guide-nav-sub ${x===d?"active":""}`,onClick:()=>y(x),children:r?w.title:w.titleEn})},x)})})]},c.id)}):m.map((c,u)=>e.jsx("li",{className:"guide-nav-item",children:e.jsx("button",{className:`guide-nav-link ${u===d?"active":""}`,onClick:()=>y(u),children:r?c.section.title:c.section.titleEn})},u))}),o&&e.jsx("div",{className:"guide-sidebar-footer",children:o})]}),e.jsxs("div",{className:"guide-content",children:[e.jsx("div",{className:"guide-content-header",children:e.jsx("h1",{children:r?f.section.title:f.section.titleEn})}),e.jsx("div",{className:"guide-section",children:e.jsx("div",{className:"markdown-body",children:e.jsx(O,{remarkPlugins:[D],rehypePlugins:[q],components:Z,children:r?f.section.content:f.section.contentEn})})}),p,e.jsxs("div",{className:"guide-section-nav",children:[e.jsxs("button",{disabled:d===0,onClick:()=>y(d-1),children:[e.jsx("i",{className:"fa-solid fa-chevron-left"})," ",r?"이전":"Previous"]}),e.jsxs("button",{disabled:d===m.length-1,onClick:()=>y(d+1),children:[r?"다음":"Next"," ",e.jsx("i",{className:"fa-solid fa-chevron-right"})]})]})]})]})]})}const _={id:"prompt-basics",icon:"fa-lightbulb",title:"프롬프트 기초",titleEn:"Prompt Fundamentals",sections:[{title:"프롬프트란 무엇인가",titleEn:"What is a Prompt",content:`AI 모델에게 원하는 결과를 얻기 위해 전달하는 입력 텍스트를 **프롬프트(Prompt)**라고 합니다.
...
> Prompt writing is not about "getting it perfect the first time" but about "iterative improvement."`}]},Y={id:"prompt-evaluation",icon:"fa-clipboard-check",title:"평가 기준 & 루브릭",titleEn:"Evaluation Criteria & Rubrics",sections:[{title:"프롬프트 평가 기준",titleEn:"Prompt Evaluation Criteria",content:`프롬프트의 품질을 객관적으로 평가하기 위한 5대 평가 기준입니다.
...
> Prompt writing skill is not innate — it improves with repeated practice.`}]},V={id:"prompt-techniques",icon:"fa-wand-magic-sparkles",title:"프롬프트 기법",titleEn:"Prompt Techniques",sections:[{title:"핵심 프롬프트 기법",titleEn:"Core Prompt Techniques",content:`AI에서 효과적으로 사용되는 핵심 프롬프트 기법들을 소개합니다.
...
> Advanced strategies are most effective when applied after mastering fundamental techniques.`}]},X={id:"prompt-examples",icon:"fa-flask",title:"실전 예시 & 실습",titleEn:"Examples & Practice",sections:[{title:"GitHub Copilot 프롬프트 예시",titleEn:"GitHub Copilot Prompt Examples",content:`GitHub Copilot에서 실제 사용하는 프롬프트 예시와 평가입니다.
...
> Practice grows faster with colleagues than alone. Actively use team exercises.`}]};function se(){const{language:t}=k(),i=t==="ko";return e.jsx(e.Fragment,{children:e.jsx(J,{seoTitle:"프롬프트 실습",seoTitleEn:"Prompt Lab",seoDescription:"프롬프트 작성 기법, 평가 기준, 실전 예시 및 실습 가이드",path:"/prompt-eval",dataFiles:[_,Y,V,X],sidebarHeader:e.jsx(M,{}),sidebarFooter:e.jsxs(e.Fragment,{children:[e.jsxs(v,{to:"/prompt-eval/workshop",className:"guide-sidebar-cta workshop",children:[e.jsx("i",{className:"fa-solid fa-wand-magic-sparkles"}),e.jsxs("div",{children:[e.jsx("strong",{children:i?"프롬프트 작성 평가":"Writing Evaluation"}),e.jsx("span",{children:i?"자동 채점 & 수정 재평가":"Auto-score & re-evaluate"})]})]}),e.jsxs(v,{to:"/prompt-eval/practice",className:"guide-sidebar-cta practice",children:[e.jsx("i",{className:"fa-solid fa-clipboard-check"}),e.jsxs("div",{children:[e.jsx("strong",{children:i?"종합 실습 테스트":"Full Practice Test"}),e.jsx("span",{children:i?"퀴즈 + 평가 + 작성 (250점)":"Quiz + Eval + Write (250pts)"})]})]})]}),ctaBanner:e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"prompt-practice-cta",children:[e.jsxs("div",{className:"prompt-practice-cta-text",children:[e.jsx("h3",{children:i?"프롬프트 작성 평가":"Prompt Writing Evaluation"}),e.jsx("p",{children:i?"프롬프트를 직접 작성하고 SCORE 기준으로 자동 채점! 수정하며 점수 변화를 확인하세요.":"Write prompts and get auto-scored! Edit and track your score improvements."})]}),e.jsxs(v,{to:"/prompt-eval/workshop",className:"prompt-practice-cta-btn",children:[e.jsx("i",{className:"fa-solid fa-wand-magic-sparkles"}),i?"작성 평가 시작":"Start Workshop"]})]}),e.jsxs("div",{className:"prompt-practice-cta",style:{background:"linear-gradient(135deg, rgba(56,161,105,0.08), rgba(56,161,105,0.02))",borderColor:"rgba(56,161,105,0.2)"},children:[e.jsxs("div",{className:"prompt-practice-cta-text",children:[e.jsx("h3",{children:i?"종합 실습 테스트":"Full Practice Test"}),e.jsx("p",{children:i?"선택형 퀴즈 + 프롬프트 평가 + 직접 작성까지, 250점 만점 종합 실습을 진행하세요.":"Take a 250-point practice: quiz + evaluation + writing exercises."})]}),e.jsxs(v,{to:"/prompt-eval/practice",className:"prompt-practice-cta-btn",style:{background:"#38a169"},children:[e.jsx("i",{className:"fa-solid fa-clipboard-check"}),i?"종합 실습 시작":"Start Practice"]})]})]})})})}export{se as default};
