import{l as e}from"./index-CoLp6sD3.js";import{G as t}from"./GuidePage-CUseqKV7.js";/* empty css                 */import"./SEOHead-Dau23Hkp.js";import"./TipBox-BvSBYsrC.js";import"./index-HaUwQNcv.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
> Stuck on a term? Ask JNU GPT to "explain this so a new staff member understands."`}]},o={id:"tips",icon:"fa-lightbulb",title:"실전 팁",titleEn:"Practical Tips",sections:[{title:"좋은 답을 얻는 프롬프트 팁",titleEn:"Tips for Better Prompts",content:`같은 AI라도 어떻게 묻느냐에 따라 결과가 크게 달라집니다.
...
- JNU GPT is campus-only and safer, but still minimize sensitive data.`}]},n={id:"resources",icon:"fa-graduation-cap",title:"함께 공부할 자료",titleEn:"Study Together",sections:[{title:"과정별 추천 학습 순서",titleEn:"Recommended Learning Path",content:`교육이 끝난 뒤에도 스스로 이어서 공부할 수 있도록 순서를 제안합니다.
...
**100. Build your own tips system** — save effective prompts in your project; a personalized prompt library becomes your edge.`}]},r={id:"ai-practice",icon:"fa-comment-dots",title:"AI 실전 사용법",titleEn:"AI Tools in Practice",sections:[{title:"실전 핵심 요약",titleEn:"Practical Essentials",content:`### 1. 기본 원리 — 구체적으로 물을수록 실전 답이 나옵니다
...
> Many other keywords circulate online (SELFREFINE, X10THINK…), but most overlap with the above or are unreliable. **Start with the highlighted ones.**`},{title:"설명 수준·대상 정하기",titleEn:"Depth & Audience",content:`> "쉽게 설명해줘"는 너무 막연합니다. **누구에게 · 어느 수준으로** 설명할지 콕 집으면 결과가 완전히 달라집니다. (아래 예시 주제 = 2일차 실습의 **AHP** — Analytic Hierarchy Process · 계층분석법)
...
> **Security**: 전남대GPT is campus-only, safer than public services — but still minimize sensitive data (IDs, unpublished research).`},{title:"제공사별 모델",titleEn:"Models by Provider",subtitle:"2026.07.07 기준",subtitleEn:"as of 2026-07-07",content:`> 회사마다 **설계 철학과 강점**이 다릅니다. 아래는 아키텍처·용도 관점의 **상세 안내**입니다. (구체 수치·벤치마크는 자주 바뀌어 생략 — 잘 모르면 Auto)
...
| Grok Code Fast | coding | fast code tasks | |`}]};function h(){return e.jsx(t,{seoTitle:"부록",seoTitleEn:"Appendix",seoDescription:"용어 해설, 실전 팁, AI 실전 사용법, AI 모델 안내 — 교육과 더불어 공부할 부록 자료",path:"/appendix",dataFiles:[a,o,n,i,r,s]})}export{h as default};
