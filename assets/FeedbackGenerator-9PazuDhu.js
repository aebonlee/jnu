import{n as y,v as A,r as h,j as e}from"./index-rtfHiZbU.js";import{u as S,A as C,T as $}from"./AIProviderSelect-U9t-aRFq.js";import{u as F,A as w}from"./useApiKeys-BAqDlieI.js";import{S as I}from"./SEOHead-5n06iJrJ.js";import"./index-DpHdp9F7.js";function E({studentName:s,courseName:r,assignmentName:d,grade:t,strengths:i,improvements:c,tone:m,language:u}){const g=u==="ko"?"한국어":"English",p={encouraging:"격려하는",constructive:"건설적인",formal:"공식적인",friendly:"친근한"};return[{role:"system",content:`You are an experienced educator who provides thoughtful, personalized feedback to students. Your feedback should be specific, actionable, and motivating. Always respond in ${g}.`},{role:"user",content:`다음 정보를 바탕으로 학생 개인화 피드백을 작성해주세요.
