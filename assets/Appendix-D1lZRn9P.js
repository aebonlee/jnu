import{l as e}from"./index-iGF3yaPg.js";import{G as t}from"./GuidePage-CoYSpB47.js";/* empty css                 */import"./SEOHead-DRipEIbF.js";import"./index-fUn-f4hN.js";import"./index-CxN3oAuj.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
> Stuck on a term? Ask CNU GPT to "explain this so a new staff member understands."`}]},n={id:"tips",icon:"fa-lightbulb",title:"실전 팁",titleEn:"Practical Tips",sections:[{title:"좋은 답을 얻는 프롬프트 팁",titleEn:"Tips for Better Prompts",content:`같은 AI라도 어떻게 묻느냐에 따라 결과가 크게 달라집니다.
...
- CNU GPT is campus-only and safer, but still minimize sensitive data.`}]},i={id:"resources",icon:"fa-graduation-cap",title:"함께 공부할 자료",titleEn:"Study Together",sections:[{title:"과정별 추천 학습 순서",titleEn:"Recommended Learning Path",content:`교육이 끝난 뒤에도 스스로 이어서 공부할 수 있도록 순서를 제안합니다.
...
> Ask CNU GPT to "make a 30-minute beginner study plan" for any topic.`},{title:"혼자서도 잘 하는 연습법",titleEn:"How to Practice Solo",content:`- **하루 1프롬프트**: 오늘 한 업무 하나를 AI로 다시 해보기
