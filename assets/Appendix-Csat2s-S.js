import{l as e}from"./index-CEZyCjrw.js";import{G as t}from"./GuidePage-D0xVGNTJ.js";/* empty css                 */import"./SEOHead-CRpzcaOI.js";import"./TipBox-XelDJ-SJ.js";import"./index-CY62wUGc.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
> Stuck on a term? Ask JNU GPT to "explain this so a new staff member understands."`}]},n={id:"tips",icon:"fa-lightbulb",title:"실전 팁",titleEn:"Practical Tips",sections:[{title:"좋은 답을 얻는 프롬프트 팁",titleEn:"Tips for Better Prompts",content:`같은 AI라도 어떻게 묻느냐에 따라 결과가 크게 달라집니다.
