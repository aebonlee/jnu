import{l as e}from"./index-DSQvnYuj.js";import{G as t}from"./GuidePage-aTEB6Xws.js";/* empty css                 */import"./SEOHead-BFU1GVYI.js";import"./TipBox-VcJ2jIec.js";import"./index-CzBeer20.js";const n={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
**100. Build your own tips system** — save effective prompts in your project; a personalized prompt library becomes your edge.`}]},s={id:"chatgpt-codes",icon:"fa-key",title:"ChatGPT 활용 키워드",titleEn:"ChatGPT Prompt Keywords",sections:[{title:"핵심 키워드 5선",titleEn:"Top 5 Keywords",content:`> **먼저 알아두세요.** 여기 정리한 키워드는 ChatGPT·클로드의 **공식 명령어가 아닙니다.** ELI5·TL;DR처럼 널리 쓰이는 몇 개를 빼면, **대부분은 "이런 식으로 요청해줘"를 짧게 부르려고 임의로 붙인 별칭 — 즉 구분용 키워드**입니다. AI가 그 단어를 특별히 알아듣는 게 아니라, **쓰는 사람이 기억·분류하기 쉽게** 만든 이름에 가깝습니다.
...
### 6. Where it helps
Content planning (Reels/YouTube/Shorts), writing (email/ads/scripts), idea expansion, automation design, problem-solving.`},{title:"활용 키워드 01–20",titleEn:"Codes 01–20",content:`> 사용법: 질문이나 내용 뒤(또는 앞)에 코드를 붙이면 됩니다. 예) "이 문장 자연스럽게 바꿔줘 /human"
...
| /cta | Call to action (clicks/comments) | add a CTA line |`},{title:"활용 키워드 21–40",titleEn:"Codes 21–40",content:`| 코드 | 용도 (효과) | 예시 |
| --- | --- | --- |
...
| /workflow | Organize workflow (whole process) | organize the video-production flow |`},{title:"활용 키워드 41–60",titleEn:"Codes 41–60",content:`| 코드 | 용도 (효과) | 예시 |
| --- | --- | --- |
...
| /engagement | Engagement focus (comments/likes↑) | make an engagement line |`},{title:"활용 키워드 61–80",titleEn:"Codes 61–80",content:`| 코드 | 용도 (효과) | 예시 |
| --- | --- | --- |
...
| /rank | Rank (prioritize) | rank these |`},{title:"활용 키워드 81–100",titleEn:"Codes 81–100",content:`| 코드 | 용도 (효과) | 예시 |
| --- | --- | --- |
