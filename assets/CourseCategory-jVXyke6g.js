import{C as S,r as u,l as e,F as O,E as W,L as B}from"./index-DfNTBIp5.js";import{S as Q}from"./SEOHead-cH-8JJ3B.js";import{m as P}from"./markdownComponents-CyXcnyuW.js";import{g as L}from"./courses-D6Ru7kQm.js";import{M as z}from"./materials-CQHC2qJl.js";import{M as I,r as K}from"./TipBox-Cq0q9Jf7.js";import{r as R}from"./index-DTjMUP0c.js";function F({text:i}){const{language:s}=S(),[r,d]=u.useState(!1),m=()=>{const o=document.createElement("textarea");o.value=i,o.style.position="fixed",o.style.opacity="0",document.body.appendChild(o),o.select();try{document.execCommand("copy")}catch{}document.body.removeChild(o)},p=()=>{try{const o=navigator.clipboard?.writeText(i);o&&typeof o.catch=="function"?o.catch(()=>m()):m()}catch{m()}d(!0),window.setTimeout(()=>d(!1),1500)};return e.jsxs("div",{className:"prompt-block",children:[e.jsxs("div",{className:"prompt-block-header",children:[e.jsxs("span",{className:"prompt-block-lang",children:[e.jsx("i",{className:"fa-solid fa-terminal"})," ",s==="ko"?"프롬프트":"PROMPT"]}),e.jsxs("button",{type:"button",className:`prompt-copy-btn${r?" copied":""}`,onClick:p,"aria-label":s==="ko"?"프롬프트 복사":"Copy prompt",children:[e.jsx("i",{className:`fa-solid ${r?"fa-check":"fa-copy"}`}),r?s==="ko"?"복사됨":"Copied!":s==="ko"?"복사":"Copy"]})]}),e.jsx("pre",{className:"practice-prompt",children:e.jsx("code",{children:i})})]})}const H={foundation:[{id:"f-lab1",title:"랩 1 · 첫 대화부터 학과 안내문까지",scenario:"전남대GPT에 처음 로그인해 기본 사용법을 익히고, 실제 학과 행사 안내문을 완성합니다.",level:"입문",minutes:"약 20분",steps:[{title:"로그인하고 첫 인사",detail:"교내 계정으로 전남대GPT에 로그인한 뒤, 아래 프롬프트로 AI가 무엇을 할 수 있는지 직접 물어봅니다.",prompt:`너는 전남대학교 교직원을 돕는 AI 비서야.
...
[출력] 8장(장별 제목 + 핵심 메시지)
[흐름] 도입-방법-결과-결론`,check:"8장 구성이 나오면 이번 랩 완료!"}],result:"코드 작성 → 디버깅 → 결과 정리 → 발표 구성까지 연구 마무리 흐름을 경험했습니다."}]};function q(i){return H[i]||[]}const N=`> **오늘 이렇게 진행합니다 (8시간, 자기주도 실습).** 위에서부터 순서대로 따라 하되, 내 상황에 맞는 트랙을 고르세요.
