import{F as P,C as G,r as u,l as e}from"./index-DMrrSjaX.js";import{S as y}from"./SEOHead-BFwPrYU2.js";import{M as v,r as T}from"./index-C0jyEweb.js";import{r as E}from"./index-CjnFF0MQ.js";const c=[{id:"ai-basics",nameKo:"AI 기초",nameEn:"AI Basics",icon:"fa-robot",descKo:"생성형 AI의 기본 개념과 주요 서비스를 학습합니다.",descEn:"Learn the fundamentals of generative AI and major services."},{id:"document",nameKo:"문서 자동화",nameEn:"Document Automation",icon:"fa-file-lines",descKo:"AI를 활용한 문서 작성 및 자동화를 학습합니다.",descEn:"Learn document creation and automation with AI."},{id:"admin",nameKo:"행정 업무",nameEn:"Administration",icon:"fa-briefcase",descKo:"행정 업무에 AI를 효과적으로 활용하는 방법을 학습합니다.",descEn:"Learn how to effectively use AI in administrative tasks."},{id:"prompt",nameKo:"프롬프트 엔지니어링",nameEn:"Prompt Engineering",icon:"fa-keyboard",descKo:"효과적인 프롬프트 작성 기법을 학습합니다.",descEn:"Learn effective prompt writing techniques."}],p=[{id:"ai-overview",categoryId:"ai-basics",nameKo:"생성형 AI 개요",nameEn:"Generative AI Overview",type:"guide",contentKo:`## 생성형 AI란?
...
- **Academic integrity**: Follow institutional policies on AI use`},{id:"chatgpt-guide",categoryId:"ai-basics",nameKo:"ChatGPT 활용법",nameEn:"How to Use ChatGPT",type:"guide",contentKo:`## ChatGPT 시작하기
...
- Use GPT-4o for complex tasks, GPT-4o mini for quick queries`},{id:"claude-guide",categoryId:"ai-basics",nameKo:"Claude 활용법",nameEn:"How to Use Claude",type:"guide",contentKo:`## Claude 소개
...
| Code Exec | Artifacts | Code Interpreter |`},{id:"gemini-guide",categoryId:"ai-basics",nameKo:"Gemini 활용법",nameEn:"How to Use Gemini",type:"guide",contentKo:`## Google Gemini 소개
...
**Limitations**: Korean performance slightly behind GPT/Claude, limited image generation`},{id:"ai-comparison",categoryId:"ai-basics",nameKo:"AI 서비스 비교",nameEn:"AI Service Comparison",type:"reference",contentKo:`## 주요 AI 서비스 종합 비교
...
- $40: ChatGPT Plus + Claude Pro (best of both)`},{id:"official-doc-guide",categoryId:"document",nameKo:"공문서 작성 가이드",nameEn:"Official Document Guide",type:"guide",contentKo:`## AI를 활용한 공문서 작성
...
**Don't**: Submit without review, input sensitive data, cite unverified regulations`},{id:"meeting-minutes",categoryId:"document",nameKo:"회의록 정리 가이드",nameEn:"Meeting Minutes Guide",type:"template",contentKo:`## AI를 활용한 회의록 작성
...
Use the structured template with: Overview, Agenda, Discussion, Decisions, Action Items, Next Meeting.`},{id:"ppt-generation",categoryId:"document",nameKo:"PPT 자동 생성",nameEn:"Auto PPT Generation",type:"guide",contentKo:`## AI로 프레젠테이션 자동 제작
...
- Mention your audience for tone adjustment`},{id:"excel-automation",categoryId:"document",nameKo:"Excel 수식 자동화",nameEn:"Excel Formula Automation",type:"guide",contentKo:`## AI를 활용한 Excel 업무 자동화
...
AI can write VBA macros for repetitive tasks like merging multiple Excel files.`},{id:"hr-automation",categoryId:"admin",nameKo:"인사 문서 자동화",nameEn:"HR Document Automation",type:"guide",contentKo:`## AI를 활용한 인사 문서 자동화
...
- Never input sensitive personal information`},{id:"data-analysis-basics",categoryId:"admin",nameKo:"데이터 분석 기초",nameEn:"Data Analysis Basics",type:"guide",contentKo:`## AI를 활용한 기초 데이터 분석
...
- Correlation: "Analyze relationship between variables"`},{id:"workflow-design",categoryId:"admin",nameKo:"업무 워크플로우 설계",nameEn:"Workflow Design",type:"guide",contentKo:`## AI 기반 업무 워크플로우 설계
...
### ROI Calculation
Compare investment costs (tool subscriptions, setup time) vs savings (hours saved × hourly rate).`},{id:"admin-prompt-library",categoryId:"admin",nameKo:"업무용 프롬프트 모음",nameEn:"Prompt Library",type:"template",contentKo:`## 행정 업무용 프롬프트 라이브러리
...
- Remove sensitive data before input`},{id:"rcf-framework",categoryId:"prompt",nameKo:"RCF 프레임워크",nameEn:"RCF Framework",type:"guide",contentKo:`## RCF 프레임워크: 효과적인 프롬프트의 3요소
...
\`\`\``},{id:"role-based-prompt",categoryId:"prompt",nameKo:"역할 기반 프롬프트",nameEn:"Role-Based Prompting",type:"guide",contentKo:`## 역할 기반 프롬프트 기법
...
- Use realistic, specific roles`},{id:"chain-of-thought",categoryId:"prompt",nameKo:"단계적 프롬프트 (Chain of Thought)",nameEn:"Step-by-Step Prompting",type:"guide",contentKo:`## 단계적 프롬프트 기법
...
Each step is reviewed before proceeding to the next.`},{id:"prompt-examples",categoryId:"prompt",nameKo:"프롬프트 실전 예시",nameEn:"Practical Prompt Examples",type:"reference",contentKo:`## 프롬프트 실전 예시 모음
...
- Save successful prompts for reuse`}];function K(){const{category:r}=P(),{language:h}=G(),a=h==="ko",[I,l]=u.useState(()=>{const t=r||c[0]?.id||"ai-basics";return new Set([t])}),[d,g]=u.useState(null);u.useEffect(()=>{r&&l(t=>new Set(t).add(r))},[r]);const n=d?p.find(t=>t.id===d):null,f=t=>{l(o=>{const i=new Set(o);return i.has(t)?i.delete(t):i.add(t),i})},A=t=>{g(t),window.scrollTo({top:0,behavior:"smooth"})},C=()=>{g(null),window.scrollTo({top:0,behavior:"smooth"})},m=n?c.find(t=>t.id===n.categoryId):null;return e.jsxs(e.Fragment,{children:[e.jsx(y,{title:a?"학습자료":"Learning Materials",path:"/materials"}),e.jsx("section",{className:"page-header",children:e.jsxs("div",{className:"container",children:[e.jsx("h1",{children:a?"학습자료":"Learning Materials"}),e.jsx("p",{children:a?"교육에 필요한 자료를 카테고리별로 제공합니다.":"Educational materials organized by category."})]})}),e.jsx("section",{className:"section",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"materials-layout",children:[e.jsx("aside",{className:"materials-sidebar",children:e.jsx("nav",{children:c.map(t=>{const o=I.has(t.id),i=p.filter(s=>s.categoryId===t.id);return e.jsxs("div",{className:"sidebar-group",children:[e.jsxs("button",{className:`sidebar-item sidebar-category ${o?"expanded":""}`,onClick:()=>f(t.id),children:[e.jsx("i",{className:`fa-solid ${t.icon}`}),e.jsx("span",{className:"sidebar-category-label",children:a?t.nameKo:t.nameEn}),e.jsx("i",{className:`fa-solid fa-chevron-down sidebar-chevron ${o?"open":""}`})]}),o&&e.jsx("div",{className:"sidebar-subitems",children:i.map(s=>e.jsxs("button",{className:`sidebar-subitem ${d===s.id?"active":""}`,onClick:()=>A(s.id),children:[e.jsx("i",{className:`fa-solid ${s.type==="guide"?"fa-book":s.type==="template"?"fa-file-alt":"fa-bookmark"}`}),a?s.nameKo:s.nameEn]},s.id))})]},t.id)})})}),e.jsx("div",{className:"materials-content",children:n?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"materials-breadcrumb",children:[e.jsx("button",{className:"breadcrumb-link",onClick:C,children:a?"학습자료":"Materials"}),e.jsx("i",{className:"fa-solid fa-chevron-right"}),m&&e.jsxs(e.Fragment,{children:[e.jsx("span",{children:a?m.nameKo:m.nameEn}),e.jsx("i",{className:"fa-solid fa-chevron-right"})]}),e.jsx("span",{className:"breadcrumb-current",children:a?n.nameKo:n.nameEn})]}),e.jsx("h2",{children:a?n.nameKo:n.nameEn}),e.jsx("span",{className:"material-type",children:n.type}),e.jsx("div",{className:"markdown-body",children:e.jsx(v,{remarkPlugins:[T],rehypePlugins:[E],children:a?n.contentKo:n.contentEn})})]}):e.jsxs("div",{className:"materials-welcome",children:[e.jsx("div",{className:"materials-welcome-icon",children:e.jsx("i",{className:"fa-solid fa-book-open"})}),e.jsx("h2",{children:a?"학습자료에 오신 것을 환영합니다":"Welcome to Learning Materials"}),e.jsx("p",{children:a?"왼쪽 메뉴에서 카테고리를 펼치고 원하는 자료를 선택하세요.":"Expand a category on the left and select a material to read."}),e.jsx("div",{className:"materials-overview",children:c.map(t=>{const o=p.filter(i=>i.categoryId===t.id);return e.jsxs("div",{className:"materials-overview-card",onClick:()=>{l(i=>new Set(i).add(t.id)),o.length>0&&A(o[0].id)},children:[e.jsx("div",{className:"overview-card-icon",children:e.jsx("i",{className:`fa-solid ${t.icon}`})}),e.jsx("h4",{children:a?t.nameKo:t.nameEn}),e.jsx("p",{children:a?t.descKo:t.descEn}),e.jsxs("span",{className:"overview-card-count",children:[o.length," ",a?"개 자료":"materials"]})]},t.id)})})]})})]})})})]})}export{K as default};
