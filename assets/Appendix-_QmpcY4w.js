import{l as e}from"./index-CT4twCuK.js";import{G as t}from"./GuidePage-k4Hq1kuR.js";/* empty css                 */import"./SEOHead-C-qJCtWk.js";import"./TipBox-CxqGLJBl.js";import"./index-D96lyMob.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
> Many other keywords circulate online (SELFREFINE, X10THINK…), but most overlap with the above or are unreliable. **Start with the highlighted ones.**`}]};function p(){return e.jsx(t,{seoTitle:"부록",seoTitleEn:"Appendix",seoDescription:"용어 해설, 실전 팁, AI 실전 사용법 — 교육과 더불어 공부할 부록 자료",path:"/appendix",dataFiles:[a,r,i,n,s]})}export{p as default};
