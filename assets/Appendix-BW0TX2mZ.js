import{l as e}from"./index-DBG67qwQ.js";import{G as t}from"./GuidePage-DSiKr3OF.js";/* empty css                 */import"./SEOHead-CtYOm7K4.js";import"./TipBox-CRs1scoj.js";import"./index-DtINGaTL.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
- JNU GPT is campus-only and safer, but still minimize sensitive data.`}]},i={id:"resources",icon:"fa-graduation-cap",title:"함께 공부할 자료",titleEn:"Study Together",sections:[{title:"과정별 추천 학습 순서",titleEn:"Recommended Learning Path",content:`교육이 끝난 뒤에도 스스로 이어서 공부할 수 있도록 순서를 제안합니다.
...
> Stuck? Come back to Appendix → Glossary and Practical Tips.`}]},n={id:"claude-100",icon:"fa-wand-magic-sparkles",title:"클로드 활용 100가지",titleEn:"100 Claude Tips",sections:[{title:"프롬프트 기본기 (01–15)",titleEn:"Prompt Basics (01–15)",content:`> 클로드를 잘 쓰는 사람들의 공통점은 첫 문장부터 다릅니다. 기본기가 쌓이면 나머지는 자연스럽게 따라옵니다.
...
**100. Build your own tips system** — save effective prompts in your project; a personalized prompt library becomes your edge.`}]},o={id:"ai-practice",icon:"fa-comment-dots",title:"AI 실전 사용법",titleEn:"AI Tools in Practice",sections:[{title:"실전 핵심 요약",titleEn:"Practical Essentials",content:`### 1. 기본 원리 — 구체적으로 물을수록 실전 답이 나옵니다
...
> **One-line combo**: "Rewrite this as a formal official document (개조식·하십시오체), no translationese, within 500 characters incl. spaces."`}]},s={id:"ai-models",icon:"fa-microchip",title:"AI 모델 고르기",titleEn:"Choosing a Model",sections:[{title:"한눈에 고르는 법",titleEn:"Quick Guide",content:`> 전남대GPT는 여러 회사의 AI 모델을 골라 쓸 수 있습니다. **잘 모르겠으면 \`Auto(자동)\`** — 작업에 맞는 모델을 알아서 골라줍니다. 표시 뜻: **(고비용)** = 요금이 많이 드니 꼭 필요할 때만 · **(New)** = 최신 모델.
...
> **Tip**: pricier isn't always better. For simple tasks a light model is faster and enough — move up only if the result falls short.`},{title:"제공사별 모델",titleEn:"Models by Provider",content:`> 같은 회사도 세대·크기별로 여러 모델이 있습니다. 아래는 **큰 특징 위주** 안내이며, 실제 성능은 작업마다 다를 수 있습니다.
...
| Grok Code Fast | coding-specialized |`}]};function h(){return e.jsx(t,{seoTitle:"부록",seoTitleEn:"Appendix",seoDescription:"용어 해설, 실전 팁, AI 실전 사용법, AI 모델 안내 — 교육과 더불어 공부할 부록 자료",path:"/appendix",dataFiles:[a,r,i,n,o,s]})}export{h as default};
