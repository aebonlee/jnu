import{C as y,r as x,l as e,F as $,E as T,L as N}from"./index-DmwnfoMA.js";import{S as A}from"./SEOHead-DuSHhk1s.js";import{g as S,P as E}from"./courses-Djg7O4Nr.js";import{M}from"./materials-CQHC2qJl.js";import{M as G,r as I}from"./index-DRpZhMNc.js";import{r as F}from"./index-mLBCaw1z.js";function g({text:n}){const{language:l}=y(),[c,r]=x.useState(!1),d=()=>{const i=document.createElement("textarea");i.value=n,i.style.position="fixed",i.style.opacity="0",document.body.appendChild(i),i.select();try{document.execCommand("copy")}catch{}document.body.removeChild(i)},m=()=>{try{const i=navigator.clipboard?.writeText(n);i&&typeof i.catch=="function"?i.catch(()=>d()):d()}catch{d()}r(!0),window.setTimeout(()=>r(!1),1500)};return e.jsxs("div",{className:"prompt-block",children:[e.jsxs("button",{type:"button",className:`prompt-copy-btn${c?" copied":""}`,onClick:m,"aria-label":l==="ko"?"프롬프트 복사":"Copy prompt",children:[e.jsx("i",{className:`fa-solid ${c?"fa-check":"fa-copy"}`}),c?l==="ko"?"복사됨":"Copied":l==="ko"?"복사":"Copy"]}),e.jsx("pre",{className:"practice-prompt",children:e.jsx("code",{children:n})})]})}const K={foundation:[{id:"f-lab1",title:"랩 1 · 첫 대화부터 학과 안내문까지",scenario:"전남대GPT에 처음 로그인해 기본 사용법을 익히고, 실제 학과 행사 안내문을 완성합니다.",level:"입문",minutes:"약 20분",steps:[{title:"로그인하고 첫 인사",detail:"교내 계정으로 전남대GPT에 로그인한 뒤, 아래 프롬프트로 AI가 무엇을 할 수 있는지 직접 물어봅니다.",prompt:`너는 전남대학교 교직원을 돕는 AI 비서야.
