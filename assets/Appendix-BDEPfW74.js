import{l as e}from"./index-D7RObgBw.js";import{G as t}from"./GuidePage-w2DJr5Dq.js";/* empty css                 */import"./SEOHead-Ctbdyh_i.js";import"./TipBox-Bu-j_eoY.js";import"./index-DEmrzcyI.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
> Many other keywords circulate online (SELFREFINE, X10THINK…), but most overlap with the above or are unreliable. **Start with the highlighted ones.**`},{title:"톤·스타일 바꾸기",titleEn:"Tone & Style",content:`> 같은 내용도 **톤과 형식만 콕 집어** 지정하면 결과가 확 달라집니다. 뭉뚱그리지 말고 골라서 말하세요.
...
> **One-line combo**: "Rewrite this as a formal official document (개조식·하십시오체), no translationese, within 500 characters incl. spaces."`}]};function p(){return e.jsx(t,{seoTitle:"부록",seoTitleEn:"Appendix",seoDescription:"용어 해설, 실전 팁, AI 실전 사용법 — 교육과 더불어 공부할 부록 자료",path:"/appendix",dataFiles:[a,r,n,i,s]})}export{p as default};
