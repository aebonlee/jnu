import{l as e}from"./index-CCBRPW3C.js";import{G as t}from"./GuidePage-CHlNW0ly.js";/* empty css                 */import"./SEOHead-G9k7ivos.js";import"./TipBox-DW-dzwNB.js";import"./index-DtbD9UJC.js";const a={id:"glossary",icon:"fa-book-bookmark",title:"용어 해설",titleEn:"Glossary",sections:[{title:"생성형 AI 기본 용어",titleEn:"Generative AI Basics",content:`교육에서 자주 등장하는 핵심 용어를 모았습니다. 모르는 말이 나오면 여기에서 찾아보세요.
...
**100. Build your own tips system** — save effective prompts in your project; a personalized prompt library becomes your edge.`}]},s={id:"ai-practice",icon:"fa-comment-dots",title:"AI 실전 사용법",titleEn:"AI Tools in Practice",sections:[{title:"실전 핵심 요약",titleEn:"Practical Essentials",content:`### 1. 기본 원리 — 구체적으로 물을수록 실전 답이 나옵니다
...
> **One-line combo**: "Rewrite this as a formal official document (개조식·하십시오체), no translationese, within 500 characters incl. spaces."`}]};function p(){return e.jsx(t,{seoTitle:"부록",seoTitleEn:"Appendix",seoDescription:"용어 해설, 실전 팁, AI 실전 사용법 — 교육과 더불어 공부할 부록 자료",path:"/appendix",dataFiles:[a,r,i,n,s]})}export{p as default};
