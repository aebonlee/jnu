...
- $40: ChatGPT Plus + Claude Pro (best of both)`},{id:"official-doc-guide",categoryId:"research-writing",nameKo:"공문서 작성 가이드",nameEn:"Official Document Guide",type:"guide",contentKo:`## AI를 활용한 공문서 작성
...
**Don't**: Submit without review, input sensitive data, cite unverified regulations`},{id:"meeting-minutes",categoryId:"research-writing",nameKo:"회의록 정리 가이드",nameEn:"Meeting Minutes Guide",type:"template",contentKo:`## AI를 활용한 회의록 작성
...
Use the structured template with: Overview, Agenda, Discussion, Decisions, Action Items, Next Meeting.`},{id:"ppt-generation",categoryId:"research-writing",nameKo:"PPT 자동 생성",nameEn:"Auto PPT Generation",type:"guide",contentKo:`## AI로 프레젠테이션 자동 제작
...
- Mention your audience for tone adjustment`},{id:"excel-automation",categoryId:"data-budget",nameKo:"Excel 수식 자동화",nameEn:"Excel Formula Automation",type:"guide",contentKo:`## AI를 활용한 Excel 업무 자동화
...
AI can write VBA macros for repetitive tasks like merging multiple Excel files.`},{id:"hr-automation",categoryId:"data-budget",nameKo:"인사 문서 자동화",nameEn:"HR Document Automation",type:"guide",contentKo:`## AI를 활용한 인사 문서 자동화
...
- Never input sensitive personal information`},{id:"data-analysis-basics",categoryId:"data-budget",nameKo:"데이터 분석 기초",nameEn:"Data Analysis Basics",type:"guide",contentKo:`## AI를 활용한 기초 데이터 분석
...
- Correlation: "Analyze relationship between variables"`},{id:"workflow-design",categoryId:"research-lab",nameKo:"업무 워크플로우 설계",nameEn:"Workflow Design",type:"guide",contentKo:`## AI 기반 업무 워크플로우 설계
...
### ROI Calculation
Compare investment costs (tool subscriptions, setup time) vs savings (hours saved × hourly rate).`},{id:"admin-prompt-library",categoryId:"research-lab",nameKo:"업무용 프롬프트 모음",nameEn:"Prompt Library",type:"template",contentKo:`## 행정 업무용 프롬프트 라이브러리
...
- Remove sensitive data before input`},{id:"rcf-framework",categoryId:"foundation",nameKo:"RCF 프레임워크",nameEn:"RCF Framework",type:"guide",contentKo:`## RCF 프레임워크: 효과적인 프롬프트의 3요소
...
Each step is reviewed before proceeding to the next.`},{id:"prompt-examples",categoryId:"research-lab",nameKo:"프롬프트 실전 예시",nameEn:"Practical Prompt Examples",type:"reference",contentKo:`## 프롬프트 실전 예시 모음
...
- Save successful prompts for reuse`}];function K(){const{category:r}=P(),{language:A}=G(),a=A==="ko",[f,l]=u.useState(()=>{const t=r||c[0]?.id||"foundation";return new Set([t])}),[d,g]=u.useState(null);u.useEffect(()=>{r&&l(t=>new Set(t).add(r))},[r]);const n=d?p.find(t=>t.id===d):null,I=t=>{l(i=>{const o=new Set(i);return o.has(t)?o.delete(t):o.add(t),o})},h=t=>{g(t),window.scrollTo({top:0,behavior:"smooth"})},C=()=>{g(null),window.scrollTo({top:0,behavior:"smooth"})},m=n?c.find(t=>t.id===n.categoryId):null;return e.jsxs(e.Fragment,{children:[e.jsx(y,{title:a?"학습자료":"Learning Materials",path:"/materials"}),e.jsx("section",{className:"page-header",children:e.jsxs("div",{className:"container",children:[e.jsx("h1",{children:a?"학습자료":"Learning Materials"}),e.jsx("p",{children:a?"교육에 필요한 자료를 카테고리별로 제공합니다.":"Educational materials organized by category."})]})}),e.jsx("section",{className:"section",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"materials-layout",children:[e.jsx("aside",{className:"materials-sidebar",children:e.jsx("nav",{children:c.map(t=>{const i=f.has(t.id),o=p.filter(s=>s.categoryId===t.id);return e.jsxs("div",{className:"sidebar-group",children:[e.jsxs("button",{className:`sidebar-item sidebar-category ${i?"expanded":""}`,onClick:()=>I(t.id),children:[e.jsx("i",{className:`fa-solid ${t.icon}`}),e.jsx("span",{className:"sidebar-category-label",children:a?t.nameKo:t.nameEn}),e.jsx("i",{className:`fa-solid fa-chevron-down sidebar-chevron ${i?"open":""}`})]}),i&&e.jsx("div",{className:"sidebar-subitems",children:o.map(s=>e.jsxs("button",{className:`sidebar-subitem ${d===s.id?"active":""}`,onClick:()=>h(s.id),children:[e.jsx("i",{className:`fa-solid ${s.type==="guide"?"fa-book":s.type==="template"?"fa-file-alt":"fa-bookmark"}`}),a?s.nameKo:s.nameEn]},s.id))})]},t.id)})})}),e.jsx("div",{className:"materials-content",children:n?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"materials-breadcrumb",children:[e.jsx("button",{className:"breadcrumb-link",onClick:C,children:a?"학습자료":"Materials"}),e.jsx("i",{className:"fa-solid fa-chevron-right"}),m&&e.jsxs(e.Fragment,{children:[e.jsx("span",{children:a?m.nameKo:m.nameEn}),e.jsx("i",{className:"fa-solid fa-chevron-right"})]}),e.jsx("span",{className:"breadcrumb-current",children:a?n.nameKo:n.nameEn})]}),e.jsx("h2",{children:a?n.nameKo:n.nameEn}),e.jsx("span",{className:"material-type",children:n.type}),e.jsx("div",{className:"markdown-body",children:e.jsx(v,{remarkPlugins:[T],rehypePlugins:[x],children:a?n.contentKo:n.contentEn})})]}):e.jsxs("div",{className:"materials-welcome",children:[e.jsx("div",{className:"materials-welcome-icon",children:e.jsx("i",{className:"fa-solid fa-book-open"})}),e.jsx("h2",{children:a?"학습자료에 오신 것을 환영합니다":"Welcome to Learning Materials"}),e.jsx("p",{children:a?"왼쪽 메뉴에서 카테고리를 펼치고 원하는 자료를 선택하세요.":"Expand a category on the left and select a material to read."}),e.jsx("div",{className:"materials-overview",children:c.map(t=>{const i=p.filter(o=>o.categoryId===t.id);return e.jsxs("div",{className:"materials-overview-card",onClick:()=>{l(o=>new Set(o).add(t.id)),i.length>0&&h(i[0].id)},children:[e.jsx("div",{className:"overview-card-icon",children:e.jsx("i",{className:`fa-solid ${t.icon}`})}),e.jsx("h4",{children:a?t.nameKo:t.nameEn}),e.jsx("p",{children:a?t.descKo:t.descEn}),e.jsxs("span",{className:"overview-card-count",children:[i.length," ",a?"개 자료":"materials"]})]},t.id)})})]})})]})})})]})}export{K as default};
