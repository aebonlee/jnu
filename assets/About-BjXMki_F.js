import{l as s}from"./index-DfNTBIp5.js";import{G as i}from"./GuidePage-BPCIr3_c.js";import"./SEOHead-cH-8JJ3B.js";import"./TipBox-Cq0q9Jf7.js";import"./index-DTjMUP0c.js";const a={id:"about",icon:"fa-circle-info",title:"About",titleEn:"About",sections:[{title:"만든 취지",titleEn:"Purpose",content:`**전남대학교 생성형 AI 교육**은 교수자·직원·조교가 생성형 AI를 **실제 업무와 연구·교육에 바로 적용**할 수 있도록 돕기 위해 만든 실습 중심 교육 사이트입니다.
...
> 논문 작성이 목표인 분부터 데이터·AI를 업무에 쓰려는 다수까지, **각자 필요에 맞게** 실습할 수 있도록 구성했습니다. 처음이시면 각 실습의 회색 상자(프롬프트)를 **복사 → 전남대GPT에 붙여넣기 → [ ] 부분만 내 상황으로 바꾸기**, 이 3가지면 됩니다.`,contentEn:`**JNU Generative AI Education** is a practice-oriented site built to help faculty, staff, and teaching assistants **apply generative AI directly to their real work, research, and teaching.**
...
- **Recommended** — external resources to continue learning`},{title:"이애본 강사",titleEn:"Instructor: Aebon Lee",content:`<div class="instructor-hero">
...
<p class="ins-contact"><strong>연락처</strong> — aebon@dreamitbiz.com · <a href="https://www.dreamitbiz.com" target="_blank" rel="noopener noreferrer">www.dreamitbiz.com</a></p>`,contentEn:`<div class="instructor-hero">
...
<p class="ins-contact"><strong>Contact</strong> — aebon@dreamitbiz.com · <a href="https://www.dreamitbiz.com" target="_blank" rel="noopener noreferrer">www.dreamitbiz.com</a></p>`},{title:"정동엽 강사",titleEn:"Instructor: Dongyeop Jeong",content:`<div class="instructor-hero">
...
<div class="ins-philosophy"><div class="ins-philosophy-eyebrow">PUBLICATION · 저서</div><div class="ins-philosophy-quote">『생각의 미래』 (지식노마드, 2016)</div><div class="ins-philosophy-body">미래 사회의 변화와 직업의 진화를 예측하며, 새로운 시대에 필요한 사고력과 역량을 제시하는 책입니다.</div></div>`,contentEn:`<div class="instructor-hero">
